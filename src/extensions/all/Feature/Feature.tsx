...
class FeatureHubContent extends React.Component<{}, IFeatureState> {
    ...
    private message: string = "Agent Pool Assitance helps you selecting the appropriate ING agent pool for releases.";
    ...
    public render(): JSX.Element {
        ...
        return (
            <Page className="sample-hub flex-grow">
                <Header title={"Agent Pool Assistance" + (isV2 ? " (version 2)" : "")} />
